...
```javascript
{
	"platOrderId" : "test_plat_order_id",
	"storeCode" : "test_store_code"
}
```
...
| -------- | -------- | ----- | -------- | -------- | ------ |
|rtPlatOrderMain|rakuten平台订单表|body|true|RtPlatOrderMain对象|RtPlatOrderMain对象|
|&emsp;&emsp;additionalFeeOccurAmountToShop|Total additional fee charged to merchant.||false|number||
|&emsp;&emsp;additionalFeeOccurAmountToUser|Total additional fee charged to customer.||false|number||
|&emsp;&emsp;asurakuFlag|0: Non-Asuraku order 1: Asuraku order||false|integer(int32)||
|&emsp;&emsp;authStoreCodes|||false|array|string|
|&emsp;&emsp;cancelDueDate|取消截至时间||false|string(date-time)||
|&emsp;&emsp;carrierCode|0: PC (including Windows Smartphone and Tablet) 1: Mobile (docomo) feature phone 2: Mobile (KDDI) feature phone 3: Mobile (Softbank) feature phone 5: Mobile (WILLCOM) feature phone 11: Smartphone (iPhone) 12: Smartphone (Android) 19: Smartphone (Other) 21: Tablet (iPad) 22: Tablet (Android) 29: Tablet (Other) 99: Other, including unknown devices||false|integer(int32)||
|&emsp;&emsp;cautionDisplayDetailType|101: Beware of unpaid prepayment 102: Beware of refusal of receipt 103: Beware of refusal of receipt due to long absence 104: Be careful of returned products after unpacking 105: Beware of high service level requirements||false|integer(int32)||
|&emsp;&emsp;cautionDisplayType|0: None 1: Caution: order requires care and attention 2: Caution: order to be cancelled||false|integer(int32)||
|&emsp;&emsp;changeReasonModelListJson|更改原因||false|string||
|&emsp;&emsp;countryCode|||false|string||
|&emsp;&emsp;couponAllTotalPrice|Total coupon amount.||false|number||
|&emsp;&emsp;couponOtherPrice|Total coupon discount amount with coupon capital code other than 1.||false|number||
|&emsp;&emsp;couponShopPrice|Total coupon discount amount with coupon capital code 1.||false|number||
|&emsp;&emsp;createDept|创建部门||false|integer(int64)||
|&emsp;&emsp;createTime|创建时间||false|string(date-time)||
|&emsp;&emsp;createUser|创建人||false|integer(int64)||
|&emsp;&emsp;createdAtEnd|||false|string(date-time)||
|&emsp;&emsp;createdAtStart|||false|string(date-time)||
...
|&emsp;&emsp;ordererEmailaddress|email||false|string||
...
|data|承载数据|RtPlatOrderMainVO对象|RtPlatOrderMainVO对象|
|&emsp;&emsp;additionalFeeOccurAmountToShop|Total additional fee charged to merchant.|number||
|&emsp;&emsp;additionalFeeOccurAmountToUser|Total additional fee charged to customer.|number||
|&emsp;&emsp;asurakuFlag|0: Non-Asuraku order 1: Asuraku order|integer(int32)||
|&emsp;&emsp;cancelDueDate|取消截至时间|string(date-time)||
...
|&emsp;&emsp;cautionDisplayDetailType|101: Beware of unpaid prepayment 102: Beware of refusal of receipt 103: Beware of refusal of receipt due to long absence 104: Be careful of returned products after unpacking 105: Beware of high service level requirements|integer(int32)||
|&emsp;&emsp;cautionDisplayType|0: None 1: Caution: order requires care and attention 2: Caution: order to be cancelled|integer(int32)||
|&emsp;&emsp;changeReasonModelListJson|更改原因|string||
|&emsp;&emsp;countryCode|国家编码|string||
|&emsp;&emsp;couponAllTotalPrice|Total coupon amount.|number||
|&emsp;&emsp;couponOtherPrice|Total coupon discount amount with coupon capital code other than 1.|number||
|&emsp;&emsp;couponShopPrice|Total coupon discount amount with coupon capital code 1.|number||
|&emsp;&emsp;createDept|创建部门|integer(int64)||
|&emsp;&emsp;createTime|创建时间|string(date-time)||
|&emsp;&emsp;createUser|创建人|integer(int64)||
|&emsp;&emsp;currencyCode|币种|string||
|&emsp;&emsp;dealFlag|0: Orders do not include Rakuten Super DEAL products. 1: Orders including Rakuten Super DEAL products.|integer(int32)||
|&emsp;&emsp;deliveryClass||integer(int32)||
|&emsp;&emsp;deliveryDate|Specified Delivery Date|string(date-time)||
|&emsp;&emsp;deliveryName|快递公司名称|string||
|&emsp;&emsp;deliveryPrice|The value is 0 for payment methods those don't have extra COD charge.|number||
|&emsp;&emsp;drugFlag|0: Orders excluding pharmaceutical products 1: Orders including pharmaceutical products|integer(int32)||
|&emsp;&emsp;emailCarrierCode|0: PC (including @i.softbank.jp) 1: DoCoMo 2: au 3: SoftBank 5: WILLCOM 99: Other|integer(int32)||
|&emsp;&emsp;equalSenderFlag|0: Shopper's address is different from recipient's address. 1: For a single order, shopper's address is same with recipient's address.|integer(int32)||
|&emsp;&emsp;firstGrabDate|首次抓单时间|string(date-time)||
|&emsp;&emsp;freightChargesAmount|客付运费|number||
|&emsp;&emsp;giftcheckFlag|0: Non-gift order 1: Gift order|integer(int32)||
|&emsp;&emsp;goods||array|RtPlatOrderGoodVO对象|
|&emsp;&emsp;&emsp;&emsp;basketId|包裹ID|integer(int32)||
...
|&emsp;&emsp;markRespJson|标记返回字段|string||
...
|&emsp;&emsp;reservedeliveryCount|For reservation purchase, the value is always 1. For recurring and subscription purchase, the value is the number of confirmed orders.|integer(int32)||
...
|&emsp;&emsp;wrapping2IncludeTaxFlag|0: Tax is excluded 1: Tax is included|integer(int32)||

...
## 请求URL
- `http://{网关地址}/api/tms-system/system/propertyConfig/updateStatus `
...
## 请求示例
![](http://showdoc.zehui.local/server/index.php?s=/api/attachment/visitFile/sign/3639610517bb6b4fb31aa55f06e13152&showdoc=.jpg)
## 返回示例 
